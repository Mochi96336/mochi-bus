...
The migration planner independently rebuilds the updater proposal through the same shared API. The bundle refuses to continue unless its canonical change fingerprint matches the original updater proposal.
